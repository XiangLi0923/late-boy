...
var Er = F(() => {
  ...
  yr = (n, t) => {
    ...
    if (u != null) {
      let o, d;
      (t == null ? void 0 : t.tensorLayout) !== void 0 && t.tensorLayout === "NHWC" ? (o = n.dims[2], d = n.dims[3]) : (o = n.dims[3], d = n.dims[2]);
      let c = (t == null ? void 0 : t.format) !== void 0 ? t.format : "RGB", l = t == null ? void 0 : t.norm, m, h;
    ...
    if (a != null) {
      let o, d, c;
      (t == null ? void 0 : t.tensorLayout) !== void 0 && t.tensorLayout === "NHWC" ? (o = n.dims[2], d = n.dims[1], c = n.dims[3]) : (o = n.dims[3], d = n.dims[2], c = n.dims[1]);
      let l = t !== void 0 && t.format !== void 0 ? t.format : "RGB", m = t == null ? void 0 : t.norm, h, g;
...
var tn = F(() => {
  ...
  xr = (n, t) => {
    ...
    var _a;
    let a = ((_a = new Error().stack) == null ? void 0 : _a.split(/\r\n|\r|\n/g)) || [], u = false;
...
var jr = F(() => {
  ...
  xe();
  pt();
  $r = "ort-wasm-proxy-worker", zr = ((_a = globalThis.self) == null ? void 0 : _a.name) === $r;
  zr && (self.onmessage = (n) => {
...
async function Vr(n = {}) {
  var _a2, _b;
  var t = n, a = !!globalThis.window, u = !!globalThis.WorkerGlobalScope, o = u && ((_a2 = self.name) == null ? void 0 : _a2.startsWith("em-pthread"));
    ...
    let e = function(r) {
      try {
        ...
        if (s === "load") {
          ...
          })(i.Ob), zt(i.Ob, 0, 0, 1, 0, 0), wn(), Nt(i.Ob), Z || (Z = true);
          try {
            Ao(i.bc, i.Tb);
          } catch (f) {
            if (f != "unwind") throw f;
  ...
  function H(e) {
    throw N(e = "Aborted(" + e + ")"), _ = true, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), I == null ? void 0 : I(e), e;
  }
  function q() {
  ...
  async function Ut() {
    ...
    }) : o ? e(new WebAssembly.Instance(b, q()), b) : (K ?? (K = t.locateFile ? t.locateFile ? t.locateFile("ort-wasm-simd-threaded.wasm", h) : h + "ort-wasm-simd-threaded.wasm" : new URL("ort-wasm-simd-threaded.wasm", import.meta.url).href), r = await async function(s) {
      var f = K;
      if (!g && !k(f)) try {
  ...
  }, No = !Atomics.waitAsync || ((_b = globalThis.navigator) == null ? void 0 : _b.userAgent) && 91 > Number((navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./) || [])[2]);
  function Nt(e) {
...
`))[0] == "Error" && s.shift(), jn(s);
  ...
  var Gt, $t = {}, Vn = () => {
    var _a3;
    if (!Gt) {
      var e, r = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (((_a3 = globalThis.navigator) == null ? void 0 : _a3.language) ?? "C").replace("-", "_") + ".UTF-8", _: "./this.program" };
  ...
  function it() {
    if (0 < Re) te = it;
    else if (o) T == null ? void 0 : T(t), he();
    else {
      for (var e = Ve; 0 < e.length; ) e.shift()(t);
      0 < Re ? te = it : (t.calledRun = true, _ || (he(), T == null ? void 0 : T(t)));
    }
  }
...
var Jr = F(() => {
  "use strict";
  var _a, _b;
  rs = Vr, os = (_b = (_a = globalThis.self) == null ? void 0 : _a.name) == null ? void 0 : _b.startsWith("em-pthread");
  os && Vr();
});
var Qr;
var an;
...
var xe = F(() => {
  ...
  un = false, St = false, no = false, fs = () => {
    ...
    let o = n.wasmPaths, d = typeof o == "string" ? o : void 0, c = o == null ? void 0 : o.mjs, l = (c == null ? void 0 : c.href) ?? c, m = o == null ? void 0 : o.wasm, h = (m == null ? void 0 : m.href) ?? m, g = n.wasmBinary, [b, y] = await to(l, d, a > 1, !!g || !!h), T = false, I = [];
...
var oo = F(() => {
  ...
  ro = (n) => {
    let t = $(), a = 0, u = [], o = n || {};
    try {
      if ((n == null ? void 0 : n.logSeverityLevel) === void 0) o.logSeverityLevel = 2;
      ...
      if ((n == null ? void 0 : n.logVerbosityLevel) === void 0) o.logVerbosityLevel = 0;
      ...
      (n == null ? void 0 : n.terminate) === void 0 && (o.terminate = false);
      let d = 0;
      return (n == null ? void 0 : n.tag) !== void 0 && (d = ae(n.tag, u)), a = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, d), a === 0 && G("Can't create run options."), (n == null ? void 0 : n.extra) !== void 0 && Ze(n.extra, "", /* @__PURE__ */ new WeakSet(), (c, l) => {
      ...
      switch (d) {
        case "webnn":
          if (d = "WEBNN", ke(n, "session.disable_quant_qdq", "1", a), ke(n, "session.disable_qdq_constant_folding", "1", a), typeof o != "string") {
            let y = o == null ? void 0 : o.deviceType;
        ...
        case "webgpu":
          if (d = "JS", typeof o != "string") {
            let b = o;
            if (b == null ? void 0 : b.preferredLayout) {
...
var rn = F(() => {
  ...
  ws = (n, t) => {
    ...
    var _a, _b;
    (_b = (_a = $()).asyncInit) == null ? void 0 : _b.call(_a);
    ...
    try {
      if ([c, m] = await ao(t), (t == null ? void 0 : t.externalData) && o.mountExternalData) {
        let _ = [];
      ...
      for (let _ of (t == null ? void 0 : t.executionProviders) ?? []) if ((typeof _ == "string" ? _ : _.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof _ != "string") {
          let w = _, Z = w == null ? void 0 : w.context, j = w == null ? void 0 : w.gpuDevice, ne = w == null ? void 0 : w.deviceType, pe = w == null ? void 0 : w.powerPreference;
      ...
      d = await o._OrtCreateSession(a, u, c), (_a = o.webgpuOnCreateSession) == null ? void 0 : _a.call(o, d), d === 0 && G("Can't create a session."), (_b = o.jsepOnCreateSession) == null ? void 0 : _b.call(o), o.currentContext && (o.webnnRegisterMLContext(d, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
      let [b, y] = bs(d), T = !!(t == null ? void 0 : t.enableGraphCapture), I = [], D = [], z = [], v = [], O = [];
      for (let _ = 0; _ < b; _++) {
        let [k, w, Z] = co(d, _);
      ...
      o._free(a), c !== 0 && o._OrtReleaseSessionOptions(c) !== 0 && G("Can't release session options."), m.forEach((b) => o._free(b)), (_c = o.unmountExternalData) == null ? void 0 : _c.call(o);
    }
  }, yt = (n) => {
    var _a, _b, _c;
    let t = $(), a = $e.get(n);
    ...
    let [u, o, d, c, l] = a;
    c && (l && t._OrtClearBoundOutputs(c.handle) !== 0 && G("Can't clear bound outputs."), t._OrtReleaseBinding(c.handle) !== 0 && G("Can't release IO binding.")), (_a = t.jsepOnReleaseSession) == null ? void 0 : _a.call(t, n), (_b = t.webnnOnReleaseSession) == null ? void 0 : _b.call(t, n), (_c = t.webgpuOnReleaseSession) == null ? void 0 : _c.call(t, n), o.forEach((m) => t._OrtFree(m)), d.forEach((m) => t._OrtFree(m)), t._OrtReleaseSession(u) !== 0 && G("Can't release session."), $e.delete(n);
    ...
    try {
      ...
      (_a = c.jsepOnRunStart) == null ? void 0 : _a.call(c, h), (_b = c.webnnOnRunStart) == null ? void 0 : _b.call(c, h);
      let W;
      ...
      for (let A = 0; A < z; A++) {
        ...
        try {
          ...
          H = Ot(ve);
          let se = y == null ? void 0 : y.outputPreferredLocations[u[A]];
          if (H === "string") {
      ...
      (_c = c.webnnOnRunEnd) == null ? void 0 : _c.call(c, h), c.stackRestore(Z), N.forEach((W) => c._OrtReleaseTensor(W)), _.forEach((W) => c._OrtReleaseTensor(W)), k.forEach((W) => c._free(W)), v !== 0 && c._OrtReleaseRunOptions(v), O.forEach((W) => c._free(W));
    }
  }, Et = (n) => {
    let t = $(), a = $e.get(n);
  ...
  Me = () => !!Y.wasm.proxy && typeof document < "u", et = false, Lt = false, _t = false, dn = /* @__PURE__ */ new Map(), ze = (n, t) => {
    ...
    if (!Lt) {
      ...
      if (et = true, Me()) return new Promise((n, t) => {
        ie == null ? void 0 : ie.terminate(), eo().then(([a, u]) => {
          try {
...
export {
  ts as InferenceSession,
  xr as TRACE,
  De as TRACE_EVENT_BEGIN,
  Ue as TRACE_EVENT_END,
  _e as TRACE_FUNC_BEGIN,
  Pe as TRACE_FUNC_END,
  de as Tensor,
  au as default,
  Y as env,
  qe as registerBackend
};
...
onnxruntime-web/dist/ort.wasm.bundle.min.mjs:
   ...
   *)
*/
//# sourceMappingURL=onnxruntime-web_wasm.js.map
